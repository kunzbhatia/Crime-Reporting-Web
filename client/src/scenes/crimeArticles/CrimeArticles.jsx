...
const CrimeArticles = () => {
    ...
    return (
        <Box>
            <Navbar />
            <Box display="flex" justifyContent="space-between" sx={{ background: mode === "dark" ? "rgba(76, 76, 76, 0.54)" : "#FBF6EA", width: "100%", height: "30rem" }}>
            ...
            <Box padding="5rem">
                <Typography variant="h2" sx={{ fontFamily: "Sen", fontSize: "2rem", fontWeight: 700, letterSpacing: "-0.055rem", lineHeight: "3rem" }}>Recent Crime Incidents</Typography>
